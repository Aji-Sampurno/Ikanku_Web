<div class="row">
	<div class="col-lg-12">
		<div class="p-5">
			...
			<form class="user" action="<?php echo base_url('ikanku/update_edukasi');?>"method="post">
				...
				<div class="form-group">
					<label>Isi</label>
					<input type="textarea" class="form-control form-control" id="isi" name="isi" placeholder="Isi" value="<?php echo $baris->isi; ?>" required="">
				</div>
				<button type="submit" class="btn btn-success btn-icon-split">
					<span class="text">Simpan</span>
				</button>
			</form><?php } ?><hr>
			<div class="text-center"><a class="small" href="<?php echo base_url('ikanku/artikel')?>">Kembali</a>
			</div>
		</div>
	</div>
</div>
